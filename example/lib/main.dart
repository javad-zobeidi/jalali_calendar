            ...
            Center(
              child: Column(
                children: <Widget>[
                  ...
                  Text("\nزمان و تاریخ فعلی سیستم :  ${persianDate.getNow}",textAlign: TextAlign.center,textDirection: TextDirection.rtl,),
                  Divider(),
                  Text("تقویم ",textAlign: TextAlign.center,),
                  Text(_value,textAlign: TextAlign.center,),
                  Divider(),
                  Text(_valuePiker,textAlign: TextAlign.center,),
                ],
              ),
            )
...
/*      initialYear: 1368,
      ...
      onConfirm: (year, month, day) {
        _changeDatetime(year, month, day);
        _valuePiker = " تاریخ ترکیبی : $_datetime  \n سال : $year \n  ماه :   $month \n  روز :  $day";
      }
    );
  }
